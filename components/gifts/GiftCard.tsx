...
export default function GiftCard({ gift, onContribute }: GiftCardProps) {
  ...
  return (
    <div
      className={`bg-white rounded-lg overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 ${isCompleted ? 'opacity-90 grayscale' : ''
        }`}
    >
      {/* Image */}
      <div className={`relative bg-gray-100 overflow-hidden group ${heightIndex === 0 ? 'h-48 min-h-[12rem]' :
      ...
      <div className="p-5">
        ...
        <button
          ...
          className={`w-full py-3 px-4 rounded-lg text-sm font-medium transition-all duration-300 font-sans ${isCompleted
