...
export default function RSVPButton() {
  ...
  return (
    ...
    >
      ...
      <span className={`text-sm lg:text-base xl:text-lg transition-all duration-500 overflow-hidden whitespace-nowrap ${isFooterVisible ? 'w-0 opacity-0' : 'w-auto opacity-100'
        }`}>
